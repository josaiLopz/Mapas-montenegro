...
<div class="materials-form-page">
  <div class="materials-form-card">
    ...
    <div class="materials-form-head">
      <div>
        <h3 class="materials-form-title"><?= __('Editar Material') ?></h3>
        <p class="materials-form-subtitle">
          Actualiza la información del material y guarda los cambios.
        </p>
      </div>
      ...
      <div class="materials-form-actions">
        ...
        <?= $this->Form->postLink(
          ...
          [
            'confirm' => __('¿Estás seguro de que quieres eliminar # {0}?', $material->id),
            'class' => 'button button-outline materials-danger'
          ]
        ) ?>
      </div>
    </div>
    ...
    <?= $this->Form->create($material, ['class' => 'materials-form']) ?>
      ...
      <div class="materials-form-footer">
        <?= $this->Form->button(__('Guardar Cambios'), ['class' => 'button materials-save']) ?>
