...
<section class="about-form-page">
    <header class="about-form-header">
        <h2>Agregar About Us</h2>
        <p>Crea un nuevo bloque de contenido para la pagina institucional.</p>
    </header>
    ...
    <article class="about-form-card">
        ...
        <div class="about-form-grid">
            ...
            <?= $this->Form->control('image_file', ['type' => 'file', 'label' => 'Imagen']) ?>

            <?= $this->Form->control('active', ['type' => 'checkbox', 'label' => 'Activo']) ?>
        </div>

        <div class="about-form-actions">
            <?= $this->Form->button('Guardar', ['class' => 'button button-primary']) ?>
