...
<body>
    ...
    <br><br><br><br><br><br><br>
        ...
        <div class="label-input-container">
            <h1><img src="portadas/CALCULADORA-DE-DESCUENTOS_Logo_RAP.png" alt="" style="max-width: 70%;"></h1>
            <h2 style="color:#1c1c1c;">Bienvenido, <?php echo htmlspecialchars($userName); ?>!</h2>

        </div><br>
        <div class="input-container">
            <label for="precioBase">PRECIO BASE $</label>
            <input type="number" id="precioBase" value="728.00" readonly>
        </div>
        <?php
            if ($metas->num_rows > 0) {
                while ($row = $metas->fetch_assoc()) {
                    ...
                    echo '<input type="number" id="meta' . htmlspecialchars($row['id']) . '" name="meta_rap[]" value="' . htmlspecialchars($row['meta_rap']) . '" oninput="calcularDescuentos()" style="background-color: #f5c8c8;">';
                    echo '</div>';
                }
            } else {
        ...
        <table border="1">
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td id="total" style="background-color:#3C8DBC;font-size:20PX ;"></td>
            </tr>
        </table>
