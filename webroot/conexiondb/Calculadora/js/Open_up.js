function calcularDescuentos() {
    ...
    var sumaUnidades = (unidadesPrecioRegular + unidadesAnticipadas)
    document.getElementById("sumaUnidades").textContent = sumaUnidades.toLocaleString();
    ...
    document.getElementById("descuentoBase").textContent = '$' + descuentoBase.toFixed(2);
    ...
    document.getElementById("descuentoPagoPuntual").textContent = '$' + descuentoPagoPuntual.toFixed(2);
   ...
   var resultadodescuentoMeta = (resultadoPagoPuntual - (resultadoBase * porcentajeDescuentoMeta / 100))
    ...
    var resultadoProntoPago = resultadodescuentoMeta - descuentoProntoPago;
    ...
    document.getElementById("descuentoProntoPago").textContent = '$' + descuentoProntoPago.toFixed(2);
    ...
    // Calcular descuento no devolución si el checkbox está activado y se cumplen las condiciones
    var porcentajeDescuentoNoDevolucion = noDevolucionChecked && sumaUnidades >= meta ? 2 : 0;
    ...
    document.getElementById("descuentoNoDevolucion").textContent = '$' + descuentoNoDevolucion.toFixed(2);
    ...
    // document.getElementById("multi2").textContent = '$' + ((resultadoBase - (resultadoBase * porcentajeDescuentoMeta / 100)) * unidadesPrecioRegular).toFixed(2);

    // Calcular el total de descuentos
    var suma = descuentoPagoPuntual * unidadesPrecioRegular + descuentoProntoPago * unidadesPrecioRegular + descuentoNoDevolucion * unidadesPrecioRegular;
    document.getElementById("total").textContent = '$' + suma.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 });
    document.getElementById("meta_porcentaje").textContent = crecimiento.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + "%";
