function calcularDescuentos() {
    ...
    var porcentajeDescuentoBase = 40;
    ...
    //RESULTAO DE CRECIMIENTO META 
    var resultadoCrecimientoMeta = resultadoPagoPuntual - (precioBase * porcentajeDescuentoMeta / 100);
    ...
    var resultadoProntoPago = resultadoCrecimientoMeta - descuentoProntoPago;

    // var prueba = (resultadoBase * porcentajeDescuentoMeta / 100);
    // document.getElementById("prueba1").textContent = descuentoProntoPago;
    ...
    var porcentajeDescuentoNoDevolucion = noDevolucionChecked && unidadesPrecioRegular >= meta ? 2 : 0;
    ...
    document.getElementById("descuentoMeta").textContent = '$' + (precioBase * porcentajeDescuentoMeta / 100).toFixed(3);
    document.getElementById("resultadoMeta").textContent = '$' + resultadoCrecimientoMeta.toFixed(2);
    document.getElementById("multi2").textContent = '$' + ((precioBase * porcentajeDescuentoMeta / 100) * unidadesPrecioRegular).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 });

    // Calcular el total de descuentos
    var suma = descuentoPagoPuntual * unidadesPrecioRegular + descuentoProntoPago * unidadesPrecioRegular + descuentoNoDevolucion * unidadesPrecioRegular + ((precioBase * porcentajeDescuentoMeta / 100) * unidadesPrecioRegular);
