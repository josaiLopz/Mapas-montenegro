...
return function (RouteBuilder $routes): void {
    ...
    $routes->connect(
        '/schools/estados-por-usuario/:userId',
        ['controller' => 'Schools', 'action' => 'estadosPorUsuario'],
        ['pass' => ['userId'], 'userId' => '\d+']
    );

    $routes->connect(
        '/schools/municipios-por-estado/:estadoId',
        ['controller' => 'Schools', 'action' => 'municipiosPorEstado'],
        ['pass' => ['estadoId'], 'estadoId' => '\d+']
    );
